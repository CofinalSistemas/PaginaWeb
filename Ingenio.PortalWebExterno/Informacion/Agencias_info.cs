        ...
        public List<Agencia> ObtenerAgencias()
        {
            return new List<Agencia>()
            {
                new Agencia()
                {
                    ...
                    foto = "https://www.cideu.org/wp-content/uploads/Pasto5.jpg"
                },
                new Agencia()
                {
                    Id = "Sandona",
                    ...
                    foto = "/img/Img_Web2/Agencias/Sandona/sandona_agencia.jpg"
                },
                new Agencia()
                {
                    Id = "Ipiales",
                    ...
                    foto = "https://situr.narino.gov.co/storage/Clientes/situr_narino/principal/imagenes/contenidos/19-19_Parque_20_de_Julio_y_Catedral_de_Ipiales.JPG",
                },
                new Agencia()
                {
                    Id = "Consaca",
                    ...
                    foto = "https://cdn.municipios.com.co/fotos/755-2017-11-25-17-06-913-L.jpg",
                },
                new Agencia()
                {
                    Id = "Buesaco",
                    ...
                    foto = "/img/Img_Web2/Agencias/Buesaco/buesaco_agencia.jpg"
                },
                new Agencia()
                {
                    Id = "Taminango",
                    ...
                    foto = "/img/Img_Web2/Agencias/Buesaco/taminango_agencia.jpg"
                ...
                new Agencia()
                {
                    ...
                    foto = "https://2.bp.blogspot.com/-mvbWdO5axAM/WB0pINKgccI/AAAAAAAAAFg/T7BNIMT4imUtvdT7PrOaNje65lFUYUKMACEw/s1600/Iglesia_Ntra._Sra._del_Rosario.JPG",
                },
                new Agencia()
                {
                    Id = "Tumaco",
                    ...
                    Departamento = "Nariño",
                    Mapas = "",
                    foto = "https://situr.narino.gov.co/storage/Clientes/situr_narino/principal/imagenes/contenidos/1063-31_Pen%CC%83a_El_Morro_y_Kioscos.jpg",
                },
                new Agencia()
                {
                    Id = "Linares",
                    ...
                    foto = "https://upload.wikimedia.org/wikipedia/commons/a/ae/Linares_%28plaza_principal%29.png",
                },
                new Agencia()
                {
                    Id = "Ancuya",
                    ...
                    foto = "https://www.viajarenverano.com/wp-content/uploads/2016/05/FrontisAncu.png",
                },
                new Agencia()
                {
                    Id = "Tuquerres",
                    ...
                    foto = "https://fastly.4sqi.net/img/general/600x600/45094903_5f8aHbK2KictpAWNY39eSSAQdU6DFDkTPPs95riZc9o.jpg",
                },
                new Agencia()
                {
                    Id = "Gualmatan",
                    ...
                    foto = "https://3.bp.blogspot.com/-wBi8xhRVNro/WIydRRZ7w3I/AAAAAAABBAU/baie-UrzlYw197DNh39cdKtpXL0h9jBHgCLcB/s1600/01-TEMPLO%2BPARROQUIAL-GUALMATAN.jpg",
                },
                new Agencia()
                {
                    Id = "Guachucal",
                    ...
                    foto = "https://radionacional-v3.s3.amazonaws.com/s3fs-public/senalradio/articulo-noticia/galeriaimagen/guachucal_plaza_-_copia.jpeg",
                },
                new Agencia()
                {
                    Id = "Tambo",
                    ...
                    foto = "https://www.viajarenverano.com/wp-content/uploads/2021/09/El-Tambo-Frontis1.jpg",
                },
                new Agencia()
                {
                    Id = "Spablo",
                    ...
                    foto = "https://situr.narino.gov.co/storage/Clientes/situr_narino/principal/imagenes/contenidos/2195-2_Santuario_Nuestra_Se%C3%B1ora_de_la_Playa.jpg",
                ...
                new Agencia()
                {
                    ...
                    foto = "https://situr.narino.gov.co/storage/Clientes/situr_narino/principal/imagenes/contenidos/4892-1_Parque_20_de_Julio_y_Catedral_de_Ipiales.jpg",
                ...
                new Agencia()
                {
                    ...
                    Departamento = "Nariño",
                    Mapas = "",
                    foto = "https://www.viajarenverano.com/wp-content/uploads/2020/03/Alban-Iglesia.jpg",
                ...
                new Agencia()
                {
                    ...
                    Departamento = "Nariño",
                    foto = "https://www.viajarenverano.com/wp-content/uploads/2021/11/San-Lorenzo-Centro.jpg",
                ...
                new Agencia()
                {
                    ...
                    Departamento = "Nariño",
                    foto = "https://media-cdn.tripadvisor.com/media/photo-s/19/f4/1f/17/cumbal-es-un-municipio.jpg",
                ...
                new Agencia()
                {
                    ...
                    Departamento = "Nariño",
                    foto = "https://www.colombiaturismoweb.com/DEPARTAMENTOS/NARINO/MUNICIPIOS/SAN%20BERNARDO/imagenes/DSC06427_thumb_1.JPG",
                ...
                new Agencia()
                {
                    ...
                    Departamento = "Nariño",
                    foto = "https://www.viajarenverano.com/wp-content/uploads/2019/10/El-Pe%C3%B1ol-Parque.jpg",
                ...
                new Agencia()
                {
                    ...
                    Departamento = "Nariño",
                    Mapas = "",
                    foto = "https://2.bp.blogspot.com/-qzSyN_p_Cak/VTmpcUP0XHI/AAAAAAAAABk/6jEWkG6zqcE/s1600/Imagen1.jpg",
                ...
                new Agencia()
                {
                    ...
                    foto = "https://www.viajarenverano.com/wp-content/uploads/2019/12/Nari%C3%B1o-Frontis.jpg",
                ...
                new Agencia()
                {
                    ...
                    foto = "https://www.elcolombiano.com/documents/10157/0/580x435/0c13/580d365/none/11101/INYJ/image_content_36215433_20200816094315.jpg",
                ...
                new Agencia()
                {
                    ...
                    foto = "https://www.colombiaturismoweb.com/DEPARTAMENTOS/NARINO/MUNICIPIOS/LA%20CRUZ/imagenes/Iglecia_nuestra_Se_ora_del_Carmen_thumb_1.jpg",
                ...
                new Agencia()
                {
                    ...
                    foto = "https://www.udenar.edu.co/recursos/wp-content/uploads/2018/12/ultimos-artesanos-cafeteros-de-guapuiy-chachagui-4.jpg",
                ...
                new Agencia()
                {
                    ...
                    Departamento = "Cauca",
                    foto = "https://upload.wikimedia.org/wikipedia/commons/1/1a/Catedralpopayan.jpg",
                },
                new Agencia()
                {
                    Id = "Mercaderes",
                    ...
                    Departamento = "Cauca",
                    foto = "https://www.eltiempo.com/files/article_content/uploads/2018/10/26/5bd3ba4927370.jpeg",
                ...
                new Agencia()
                {
                    ...
                    foto = "https://caracoltv.brightspotcdn.com/dims4/default/39d8175/2147483647/strip/true/crop/1000x566+0+0/resize/1000x566!/quality/90/?url=http%3A%2F%2Fcaracol-brightspot.s3.amazonaws.com%2Ffb%2F28%2F5d677744438d8427422e73e4102b%2Fpalmira-valle-del-cauca.jpg",
